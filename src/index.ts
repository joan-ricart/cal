...
createMonthCalendar(today.getFullYear(), today.getMonth() + 1);
createMonthCalendar(today.getFullYear(), today.getMonth() + 2);
createMonthCalendar(today.getFullYear(), today.getMonth() + 3);
